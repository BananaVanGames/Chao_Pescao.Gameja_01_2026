...
@onready var lo2_dialogo: AudioStream = preload("res://ui/tutorial/dialogos/L02.wav")
...
@onready var sa7_dialogo: AudioStream = preload("res://ui/tutorial/dialogos/Se07.wav")
